...
if (isset($_POST["action"]) && $_POST["action"] == "add") {
    ...
    $sql_query = "INSERT INTO `members`(`m_name`,`m_username`,`m_passwd`,`m_sex`,`m_birthday`,`m_level`,`m_email`,`m_url`,`m_phone`,`m_address`,`m_login`,`m_jointime`) VALUES(";
...
<body>
  ...
  <form action="" method="POST" name="formAdd">
    <table border="1" align="center" cellpadding=4>
      ...
      <tr>
        <td>密碼</td>
        <td><input type="password" name="m_passwd" required></td>
      </tr>
      <tr>
        <td>性別</td>
      ...
      <tr>
        <td>層級</td>
        <td><input type="radio" name="m_level" value='admin'>管理員
      ...
      <tr>
        <td>網址</td>
        <td><input type="url" name="m_url" required></td>
      </tr>
      <tr>
      <tr>
        <td>電話</td>
